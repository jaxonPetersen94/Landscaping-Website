...
export const serviceCards_Commercial = [
  serviceCard_CServOne,
  serviceCard_CServTwo,
  serviceCard_CServThree,
  serviceCard_CServFour,
  serviceCard_CServFive,
];

/* RESIDENTIAL SERVICES */
const serviceCard_LawnCare = {
...
export const serviceCards_Residential = [
  serviceCard_LawnCare,
  serviceCard_BedMaintenance,
  serviceCard_Pruning,
  serviceCard_SeasonalCare,
  serviceCard_Irrigation,
];
