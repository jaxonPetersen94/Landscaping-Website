        ...
        <div id={styles.card}>
          <div id={styles.cardTextContainer}>
            <div id={styles.cardTextFirst}>
              ...
              and national awards and are a two-time recipient of the Better Business Bureau’s
            ...
            <ul>
              ...
              <li className={styles.cardText}>
                <span className={styles.cardBulletPointTitle}>Our Mission:</span> Create
                opportunities for our team to grow and succeed by enhancing the beauty and value of
                every client’s property while exceeding their expectations every step of the way.
              </li>
            </ul>
